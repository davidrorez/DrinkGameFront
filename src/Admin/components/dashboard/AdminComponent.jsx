    ...
    <div>
      ...
      >
        ...
        >
          <div className="flex items-center">
            <div className="flex items-center h-12 w-20 ml-2 mr-2">
              <a href="/admin">
                <img src={Logo} alt="Logo" className="w-20 h-9 mr-2" />
              </a>
            </div>
            <div className="flex items-center ">
              <button id="menuBtn" onClick={handleMenuToggle}>
                <i className="fas fa-bars text-gray-500 text-lg hover:text-gray-600"></i>
              </button>
            </div>
          </div>
          <div className="flex items-centers space-x-3">
            <label className="themeSwitcherThree relative inline-flex select-none items-center">
              <input
                type="checkbox"
                checked={isDarkMode}
                ...
                className="sr-only"
              />
              <div className="shadow-card flex items-center justify-center rounded-md p-1">
                {isDarkMode ? (
                  <span className="flex h-6 w-6 items-center justify-center rounded bg-white text-dark">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                  ...
                  <span className="flex h-6 w-6 items-center justify-center rounded bg-dark">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
            ...
            <button onClick={handleLogout}>
              <i className="fa-solid fa-right-from-bracket text-gray-500 text-lg"></i>
            </button>
          </div>
        </div>
        <div
        ...
        >
          ...
          >
            <nav className={`bg-${isDarkMode ? "dark" : "white"}`}>
              ...
              <a
                ...
                style={{ textDecoration: "none" }}
              >
                <i class="fa-solid fa-user-tie mr-2"></i>Administradores
              </a>
              <a
                className="block text-gray-500 py-2.5 px-4 my-4 rounded transition duration-200 hover:bg-gradient-to-r hover:from-cyan-500 hover:to-cyan-500 hover:text-white"
                href="#"
              ...
              <a
                ...
                style={{ textDecoration: "none" }}
              >
                <i class="fa-solid fa-list mr-2"></i>Lista de retos
              </a>
            </nav>
            <a
            ...
            >
              ...
              <div className="mt-8 flex flex-wrap space-x-0 space-y-2 md:space-x-4 md:space-y-0">
                ...
                >
                  ...
                  <ChartTest titleChart={"Cantidad de usuarios registrados"} />
                </div>
                <div
                  className={`flex-1 bg-${
                    isDarkMode ? "dark" : "white"
                ...
                >
                  ...
                  <div className="my-1"></div>
                  <div className="bg-gradient-to-r from-cyan-300 to-cyan-500 h-px mb-6"></div>
                  <ChartTest titleChart={"Promedio de edades"} />
                  <div
          ...
          {activeTab === "challenges" && renderTabContent(<Challenges />)}
          {activeTab === "users" && renderTabContent(<Players />)}
          {activeTab === "admins" && renderTabContent(<Admins />)}
        </div>
      </div>
    </div>
  );
